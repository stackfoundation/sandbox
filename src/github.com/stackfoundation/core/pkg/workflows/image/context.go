...
func addDockerfileToBuildContext(dockerfileCtx io.Reader, buildCtx io.ReadCloser) (io.ReadCloser, string, error) {
        ...
        randomName := ".dockerfile." + GenerateRandomID()[:20]

        buildCtx = replaceFileTarWrapper(buildCtx, map[string]TarModifierFunc{
