...
func appendPattern(patterns []string, pattern string, invert bool) []string {
...
func composeDockerignore(includes []string, excludes []string) []string {
	var composed []string
	...
	for _, pattern := range includes {
		composed = appendPattern(composed, pattern, true)
	}

	for _, pattern := range excludes {
		composed = appendPattern(composed, pattern, false)
	}
